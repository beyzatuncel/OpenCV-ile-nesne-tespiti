...
cv2.createTrackbar("S1", "frame", 0, 359, nothing)
cv2.createTrackbar("S2", "frame", 0, 359, nothing)
cv2.createTrackbar("V1", "frame", 0, 359, nothing)
cv2.createTrackbar("V2", "frame", 0, 359, nothing)
